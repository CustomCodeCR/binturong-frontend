...
const paymentSummary = computed(() => {
  ...
  return { totalPayments, totalCollected, cashCount, transferCount };
});
...
async function loadFilters() {
  ...
  try {
    const [paymentMethodsResponse, clientsResponse] = await Promise.all([
